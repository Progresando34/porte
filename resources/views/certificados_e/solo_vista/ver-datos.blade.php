                ...
                <div class="pdf-card">
                    <div class="pdf-header">
                        <h3>
                            <span>
                                @php
                                    // Verificar si el prefijo es "VF" y mostrar "Psicología"
                                    $descripcionMostrar = $pdf['descripcion'] ?: 'Documento sin descripción';
                                    if (strtoupper($pdf['prefijo']) === 'VF') {
                                        $descripcionMostrar = 'Psicología';
                                    }
                                @endphp
                                {{ $descripcionMostrar }}
                            </span>
