...
{
    // ===== DEBUG FORZADO =====
    // Ignorar la búsqueda normal y mostrar el resultado del debug
    ...
    try {
        ...
        Log::error("Error en debug forzado: " . $e->getMessage());
    }
    
    // ===== FIN DEBUG FORZADO =====
    
    // Siempre mostrar resultados
